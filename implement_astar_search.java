   ...
   */
      ...
      public static String A_star_search(String start, String goal) throws Exception
      {
        ...
        _1_0_1_g00.adjacencies = new Edge[]{ //#22
         ...
         {
            return ((current_pos.charAt(0)-'0') - ((next_pos.charAt(0)-'0')) == 1?"lef":"rgh");
         }
   ...
   public static List<Node> printPath(Node target){
    ...
    public static Map<String, Double> getWeights(){
      ...
      public static void main(String[] args) throws Exception {
         ...
         //System.out.println("Goal Node=="+goal_toReach);
         //System.out.println(cur_position);
         //System.out.println(goal_toReach);
        ...
        //System.out.println(direction);
         ...
         //System.out.println("Curr img util="+cur_img_utility);
